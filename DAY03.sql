...
SELECT round(avg(maas)) AS maas_ortalaması FROM calisanlar2;
...
*/
--AGGREGATE METHODLARDA SUBQUERY                                    --BURADA KALDIM 2.43.20 DAY3
...
view e atadığımız SELECT komutuyla çağırırız
*/
