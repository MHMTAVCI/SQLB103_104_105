...
--HAVING 
/*
     HAVING komutu yanlızca group by komutu ile birlikte kullanılır
	 eger gruplamadan sonra bir şart varsa having komutu kullanılır
	 where kullanımı ile aynı anlamda kullanılır
*/
...
--UNION ALL
/*
   UNION tekrarlı işlemleri tek e düşürür
...
-- NOT: bu iki örnegin kesişimini aldık INTERSECT komutu ile
...
--EXCEPT OPERATOR
--ÖR:(A kümesi) - (B kümesi) - (A ve B kümesinin kesişimi)
