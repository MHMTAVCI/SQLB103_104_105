...
INSERT INTO calisanlar1 VALUES('10010', 'Mehmet Yılmaz', 19000, '2018-04-14');
...
--Calısanlar tablosundan maası 5000 den buyuk olanları isimleri listeleyiniz
...
--Calısanlar tablosundan maası 5000 olan tüm verileri listeleyiniz

SELECT * FROM calisanlar WHERE maas=5000;

-- DML -- DELETE KOMUTU
DELETE FROM calısanlar; --eger parent table baska bir child tablo ile ilişkili ise önce child table silinmelidir
